    ...
    for encoding in encodings:
        try:
            with open(filename, 'r', encoding=encoding, newline='') as csvfile:
                ...
                sentiment_counts = {}
                # Initialize total counts and total review count
                ...
                for row in reader:
                    ...
                    # Increment the total count and review count
                    total_counts[sentiment] += 1
                    total_reviews += 1

                # Add the total counts and percentages to the sentiment counts
                sentiment_counts['total'] = total_counts
                sentiment_counts['total_percentages'] = {
                    SENTIMENT_POSITIVE: round(total_counts[SENTIMENT_POSITIVE] / total_reviews * 100, 2),
                    SENTIMENT_NEGATIVE: round(total_counts[SENTIMENT_NEGATIVE] / total_reviews * 100, 2),
                    SENTIMENT_NEUTRAL: round(total_counts[SENTIMENT_NEUTRAL] / total_reviews * 100, 2)
                }
